...
public class CoordinateHouseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coordinate_house);
        ...
        // Set Touch
        myListener = new MyTouchListener(CoordinateHouseActivity.this, map);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnsave:
                ...
                Save_dialog.setMessage("คุณต้องการบันทึกพิกัดบ้านสมาชิกหรือไม่?");
                ...
                Save_dialog.setPositiveButton("ใช่", new AlertDialog.OnClickListener() {
                    public void onClick(DialogInterface dialog, int arg1) {
                        ...
                        Intent saveCoHouse = new Intent(CoordinateHouseActivity.this,
                                CoordinateHouseConfirmActivity.class);
                        Bundle b = new Bundle();
        ...
        public void onLocationChanged(Location location) {
            ...
            if (location != null) {
                ...
                if (mapPoint == null || mapPoint.isEmpty()) {
                    Toast.makeText(CoordinateHouseActivity.this, "Cannot determine current location", Toast.LENGTH_SHORT).show();
                    return;
                }
