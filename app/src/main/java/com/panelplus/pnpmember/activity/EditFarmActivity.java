...
import com.panelplus.pnpmember.database.ExternalStorage_Backup_Edit_Point_DB_OpenHelper;
...
public class EditFarmActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationListener = new EditFarmActivity.MyLocationListener();
        ...
        // Set Touch
        myListener = new MyTouchListener(EditFarmActivity.this, map);
    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.btncallout_cancle: /** Start a new Activity MyCards.java */
                ...
                delete_dialog.setPositiveButton("Yes", new AlertDialog.OnClickListener() {
                    public void onClick(DialogInterface dialog, int arg1) {

                        Poly_X.add(cachedLocationX);
                        Poly_Y.add(cachedLocationY);
                    ...
                    public void onClick(DialogInterface dialog, int arg1) {
                        ...
                        if (Poly_X.size()==0 || Poly_X.size() < 3){
                            ...
                            try {
                                ...
                                Intent myIntent = new Intent(EditFarmActivity.this, EditFarmConfirmActivity.class);
                                Bundle b = new Bundle();
        ...
        public void onLocationChanged(Location location) {
            ...
            if(location != null){
                ...
                if (mapPoint == null || mapPoint.isEmpty()) {
                    Toast.makeText(EditFarmActivity.this, "Cannot determine current location", Toast.LENGTH_SHORT).show();
                    return;
                }
