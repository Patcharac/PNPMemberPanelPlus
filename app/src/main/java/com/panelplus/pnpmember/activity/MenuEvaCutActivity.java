...
public class MenuEvaCutActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void creatDB(Context context) {
        ...
        if (context != null) {
            ...
            this.Path = appDbDir;
            String databaseName = DATABASE_EVACON_DB + "-" + UserZone + ".sqlite";
...
//                eva_con_befcut_data
                String createTableQuery2 = "CREATE TABLE IF NOT EXISTS eva_con_befcut_data (" +
                        "_id INTEGER PRIMARY KEY AUTOINCREMENT, " +
                        "   EvaBefCut_Date TEXT ," +
                        "   Con_Name TEXT ," +
                        "   Con_ID TEXT ," +
...
//                eva_con_cutting_data
                String createTableQuery3 = "CREATE TABLE IF NOT EXISTS eva_con_cutting_data (" +
                        "_id INTEGER PRIMARY KEY AUTOINCREMENT, " +
...
//                eva_contractor_data
                String createTableQuery4 = "CREATE TABLE IF NOT EXISTS eva_contractor_data (" +
                        "_id INTEGER PRIMARY KEY AUTOINCREMENT, " +
                        "   EvaCon_Date TEXT ," +
                        "   Con_Name TEXT ," +
                        "   Con_ID TEXT ," +
                ...
                this.mydb.execSQL(createTableQuery3);
                this.mydb.execSQL(createTableQuery4);
